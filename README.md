...
You need to add your specific input sensors to the input file. You can either do this in Developer tools > States og you can use the Lovelace card described below.
